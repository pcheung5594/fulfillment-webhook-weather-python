...
def processRequest(req):
    ...
    yql_url = Request(baseurl, json.dumps(data2), headers={'User-agent', 'Mozilla 5.10', 'Content-type': 'application/json', 'Accept': 'application/json'}) # this will make the method "POST"
